...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <!-- Style-sheets -->
    <!-- Bootstrap Css -->
	<!-- "{{url('Backend/css/bootstrap.css')}}" -->
    <link href="{{url('Backend/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all" />
    <!-- Bootstrap Css -->
    <!-- Bars Css -->
    <link rel="stylesheet" href="{{url('Backend/css/bar.css')}}">
    <!--// Bars Css -->
    <!-- Calender Css -->
    <link rel="stylesheet" type="text/css" href="{{url('Backend/css/pignose.calender.css')}}" />
    <!--// Calender Css -->
    <!-- Common Css -->
    <link href="{{url('Backend/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
    <!--// Common Css -->
    <!-- Nav Css -->
    <link rel="stylesheet" href="{{url('Backend/css/style4.css')}}">
    <!--// Nav Css -->
    <!-- Fontawesome Css -->
    <link href="{{url('Backend/css/fontawesome-all.css')}}" rel="stylesheet">
    <!--// Fontawesome Css -->
    <!--// Style-sheets -->
                            ...
                            <div class="dropdown-menu top-grid-scroll drop-1">
                                ...
                                <a href="#" class="dropdown-item mt-3">
                                    <div class="notif-img-agileinfo">
                                        <img src="{{url('Backend/images/clone.jpg')}}" class="img-fluid" alt="Responsive image">
                                    </div>
                            ...
                            <div class="dropdown-menu drop-3">
                                <div class="profile d-flex mr-o">
                                    <div class="profile-l align-self-center">
                                        <img src="{{url('Backend/images/profile.jpg')}}" class="img-fluid mb-3" alt="Responsive image">
                                    </div>
