            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-6 col-sm-6">
                     <ul class="lan">
                        <li><i class="fa fa-globe" aria-hidden="true"></i> Language : <img src="{{url('Frontend/images/fleg.png')}}" alt="#" /></li>
                     </ul>
                     <form action="#">
            ...
            <div class="container">
               <div class="row d_flex">
                  ...
                  <div class="col-md-4 col-sm-4 ">
                     <a class="logo" href="#"><img src="{{url('Frontend/images/logo.png')}}" alt="#" /></a>
                  </div>
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon ">
